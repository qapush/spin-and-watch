...
<main id="frontpage">
    ...
    <div class="container">
        <div class="main-content">
            ...
            <div class="main-content__subtitle">
                <a href="#photos-360" class="content__link">Zdjęcia obrotowe 360°</a>
                <span class="content__divider">|</span>
                <a href="#tours" class="content__link">Spacery wirtualne</a>
            </div>
        </div>
    </div>
    </div>
    ...
    <section id="tours" class="margin-left">
        <div class="container">
            <h2 class="title">Spacery wirtualne</h2>
            <div class="photos-desription">
               <div class="photos-description__text">
                    <p class="text">
