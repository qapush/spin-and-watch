...
sidebar
  ...
  .style.setProperty('--height-sidebar', `${window.innerHeight * 0.01}px`);
...
if (!!document.querySelector('form.filter')) {
  ...
  function sortingGoods(e) {
    ...
    data_goods.forEach((good) => {
      ...
      } else if (good.dataset.type === user_filter && good.dataset.sphere === userSphere) {
        new_data_goods.push(good);
      }
    });
...
function loadYTscript() {
  var scriptUrl = 'https://www.youtube.com/s/player/223a7479/www-widgetapi.vflset/www-widgetapi.js';
